window.addEventListener('load',function () {
    ...
    let prev=0;
    let type="all";
    let dotolist=[{id:1,content:'回家',ctime:'2019/6/7',status:false},
        {id:2,content:'吃饭',ctime:'2019/6/7',status:false},
        {id:3,content:'睡觉',ctime:'2019/6/7',status:true},
        {id:4,content:'学习',ctime:'2019/6/7',status:false},
    ];
